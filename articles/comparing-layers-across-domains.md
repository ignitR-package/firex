...
by side. The output of
[`get_layer()`](https://ignitr-package.github.io/firex/reference/get_layer.md)
is a terra `SpatRaster`, so standard terra operations work directly:
...
comparisons, use [`lapply()`](https://rdrr.io/r/base/lapply.html) to
iterate over a vector of layer IDs:
...
panel is a SpatRaster in EPSG:5070; colour scales differ by layer.
